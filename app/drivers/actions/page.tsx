...
export default async function DriversActionsPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  const localeToggleHref = locale === "es" ? "/drivers/actions/" : "/drivers/actions/es/";
  const publicHref = locale === "es" ? "/drivers/es/" : "/drivers/";
  const publicLangHref = locale === "es" ? "/drivers/" : "/drivers/es/";
